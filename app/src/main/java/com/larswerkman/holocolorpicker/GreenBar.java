...
public class GreenBar extends View {
	...
	private static final boolean ORIENTATION_DEFAULT = GreenBar.ORIENTATION_HORIZONTAL;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int measureSpec;
		if (mOrientation == GreenBar.ORIENTATION_HORIZONTAL) {
		...
		if (mOrientation == GreenBar.ORIENTATION_VERTICAL) {
	...
	protected Parcelable onSaveInstanceState() {
		...
		state.putParcelable(GreenBar.STATE_PARENT, superState);
		state.putInt(GreenBar.STATE_VALUE, getValue());
		return state;
	}
	...
	protected void onRestoreInstanceState(Parcelable state) {
		...
		Parcelable superState = savedState.getParcelable(GreenBar.STATE_PARENT);
		super.onRestoreInstanceState(superState);
		setValue(savedState.getInt(GreenBar.STATE_VALUE));
	}
}
