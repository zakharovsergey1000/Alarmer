...
public class BlueBar extends View {
	...
	private static final boolean ORIENTATION_DEFAULT = BlueBar.ORIENTATION_HORIZONTAL;
	...
	public BlueBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public BlueBar(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int measureSpec;
		if (mOrientation == BlueBar.ORIENTATION_HORIZONTAL) {
		...
		if (mOrientation == BlueBar.ORIENTATION_VERTICAL) {
	...
	protected Parcelable onSaveInstanceState() {
		...
		state.putParcelable(BlueBar.STATE_PARENT, superState);
		state.putInt(BlueBar.STATE_VALUE, getValue());
		return state;
	}
	...
	protected void onRestoreInstanceState(Parcelable state) {
		...
		Parcelable superState = savedState.getParcelable(BlueBar.STATE_PARENT);
		super.onRestoreInstanceState(superState);
		setValue(savedState.getInt(BlueBar.STATE_VALUE));
	}
}
