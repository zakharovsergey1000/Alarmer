...
public class RedBar extends View {
	...
	private static final boolean ORIENTATION_DEFAULT = RedBar.ORIENTATION_HORIZONTAL;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int measureSpec;
		if (mOrientation == RedBar.ORIENTATION_HORIZONTAL) {
		...
		if (mOrientation == RedBar.ORIENTATION_VERTICAL) {
	...
	protected Parcelable onSaveInstanceState() {
		...
		state.putParcelable(RedBar.STATE_PARENT, superState);
		state.putInt(RedBar.STATE_VALUE, getValue());
		return state;
	}
	...
	protected void onRestoreInstanceState(Parcelable state) {
		...
		Parcelable superState = savedState.getParcelable(RedBar.STATE_PARENT);
		super.onRestoreInstanceState(superState);
		setValue(savedState.getInt(RedBar.STATE_VALUE));
	}
}
