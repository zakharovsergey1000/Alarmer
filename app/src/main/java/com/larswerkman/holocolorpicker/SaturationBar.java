...
public class SaturationBar extends View {
	...
	private static final boolean ORIENTATION_DEFAULT = SaturationBar.ORIENTATION_HORIZONTAL;
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		if (isInEditMode()) {
			...
			mOrientation = a.getBoolean(R.styleable.ColorBars_bar_orientation_horizontal,
					SaturationBar.ORIENTATION_DEFAULT);
		} else {
			mBarThickness = a.getDimensionPixelSize(R.styleable.ColorBars_bar_thickness,
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int measureSpec;
		if (mOrientation == SaturationBar.ORIENTATION_HORIZONTAL) {
		...
		if (mOrientation == SaturationBar.ORIENTATION_VERTICAL) {
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		shader = new LinearGradient(mBarPointerHaloRadius, 0, x1, y1, new int[] {
				Color.WHITE, Color.HSVToColor(mHSVfullSaturationAndValue)}, null,
	...
	protected void onDraw(Canvas canvas) {
		...
		int cX, cY, c = Math.round(mBarPointerHaloRadius + mHSV[1]
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		float barPointerPosition = mValueToPositionFactor * mHSV[1];
		...
		case MotionEvent.ACTION_DOWN:
			...
			//
			mHSV[1] = barPointerPosition * mPositionToValueFactor;
			if (mPicker != null) {
				mPicker.setNewSaturation(mHSV[1]);
			}
	...
	protected Parcelable onSaveInstanceState() {
		...
		state.putParcelable(SaturationBar.STATE_PARENT, superState);
		state.putFloatArray(SaturationBar.STATE_VALUE, mHSV);
		return state;
	}
	...
	protected void onRestoreInstanceState(Parcelable state) {
		...
		Parcelable superState = savedState.getParcelable(SaturationBar.STATE_PARENT);
		super.onRestoreInstanceState(superState);
		setColor(savedState.getFloatArray(SaturationBar.STATE_VALUE));
	}
}
