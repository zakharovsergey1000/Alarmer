...
public class DaoMaster2 extends AbstractDaoMaster {
	...
	public static abstract class OpenHelper extends SQLiteOpenHelper {
		public OpenHelper(Context context, String name, CursorFactory factory) {
			super(context, name, factory, DaoMaster2.SCHEMA_VERSION);
		}

		@Override
		public void onCreate(SQLiteDatabase db) {
			Log.i("greenDAO", "Creating tables for schema version "
					+ DaoMaster2.SCHEMA_VERSION);
			DaoMaster2.createAllTables(db, false);
		}
	}

	/** WARNING: Drops all table on Upgrade! Use only during development. */
	public static class DevOpenHelper2 extends OpenHelper {
		public DevOpenHelper2(Context context, String name, CursorFactory factory) {
		...
		public void onDowngrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			throw new DowngradeException(db, oldVersion, newVersion);
		}
	}

	public DaoMaster2(SQLiteDatabase db) {
		super(db, DaoMaster2.SCHEMA_VERSION);
