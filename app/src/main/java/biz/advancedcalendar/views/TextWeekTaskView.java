...
public class TextWeekTaskView {
	 ...
	 *
	 * @param context */
	public TextWeekTaskView(Context context) {
		this(context, null, 0);
	}
	 ...
	 * @param attrs
	 * @param defStyle */
	public TextWeekTaskView(final Context context, final AttributeSet attrs) {
	 ...
	 * @param defStyle
	 *            defStyle */
	public TextWeekTaskView(Context context, AttributeSet attrs, int defStyle) {
		mDensity = context.getResources().getDisplayMetrics().density;
		mBackgroundPaint = new Paint();
		mTextPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
		mTextPaint.setTextAlign(Paint.Align.LEFT);
		taskNameTaskTimeSpacerPx = (int) (mDensity * TextWeekTaskView.TASK_NAME_TASK_TIME_SPACER_DIP);
	}
	...
	public void setCalendarViewTaskOccurrence(
		...
		mTaskInformationStrings = calendarViewTaskOccurrence.TaskInformationStringsForTextMode;
		mTaskInformationStringsTextBoundsArray = calendarViewTaskOccurrence.TaskInformationStringsForTextModeTextBounds;
		mTaskInformationStringsTextBaselinesArray = calendarViewTaskOccurrence.TaskInformationStringsForTextModeTextBaselines;
