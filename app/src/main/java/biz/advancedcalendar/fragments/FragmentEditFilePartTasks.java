...
public class FragmentEditFilePartTasks extends Fragment implements DataSaver {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			List<Long> idList = Global.getFileToEditTaskIdList();
			for (Long id : idList) {
			...
			if (mTreeViewList.getAdapter() == null) {
				if (mMySimpleAdapter == null) {
					mMySimpleAdapter = new FragmentViewTaskTreeAdapter(getActivity(),
							mManager, FragmentEditFilePartTasks.LEVEL_NUMBER);
					mMySimpleAdapter
	...
	private void fillAdapter() {
		...
		mMySimpleAdapter = new FragmentViewTaskTreeAdapter(getActivity(), mManager,
				FragmentEditFilePartTasks.LEVEL_NUMBER);
		mMySimpleAdapter
				.setTreeViewListItemDescriptions(mTreeViewListItemDescriptionList.value);
	}
	...
	public boolean isDataCollected() {
		...
		Global.setFileToEditTaskIdList(idList);
		return true;
	}
}
