...
public class FragmentEditTaskPartContacts extends Fragment implements DataSaver {
	View mView;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// entityWithDependencies.contactIdList = DataProvider
		// .getContactIdListForTask(getActivity(),
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		// ArrayList<Long> contactIdList = DataProvider.getContactIdListForTask(
		// getActivity().getApplicationContext(),
		// contactWithDependencies.task.getId(), false, true, false);
	...
	public boolean isDataCollected() {
		...
		// getActivity())
		// .getTaskWithDependents();
		// // entityWithDependencies.contactIdList should never be null here
		// // entityWithDependencies.contactIdList.clear();
		// ListView lv = (ListView)
		// getActivity().findViewById(R.id.fragment_list_listview);
		// final long[] idArray = lv.getCheckedItemIds();
		// for (long id : idArray) {
		// // entityWithDependencies.contactIdList.add(id);
		// }
		return true;
	}
