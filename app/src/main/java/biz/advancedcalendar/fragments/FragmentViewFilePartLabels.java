...
public class FragmentViewFilePartLabels extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.fragment_view_file_part_labels, container,
				false);
		mTreeView = (TreeViewList) v
				.findViewById(R.id.fragment_view_file_part_labels_treeview);
		return v;
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			Log.d(FragmentViewFilePartLabels.TAG, mManager.toString());
			for (ArrayList<TreeViewListItemDescription> iterable_element : mTreeViewListItemDescriptions.value) {
			...
			ArrayList<Long> idList = DataProvider.getLabelIdListForFile(null, getActivity()
							.getApplicationContext(), id, 0, false, true, false);
			for (Long id1 : idList) {
		...
		mMySimpleAdapter = new FragmentViewTaskTreeAdapter(getActivity(), mManager,
				FragmentViewFilePartLabels.LEVEL_NUMBER);
		mMySimpleAdapter
