...
public class FragmentEditFilePartContacts extends Fragment implements DataSaver {
	View mView;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		ArrayList<Long> contactIdList = DataProvider.getContactIdListForFile(
				null, getActivity().getApplicationContext(), Global.getFileToEdit().getId(),
				0, false, true, false);
	...
	public boolean isDataCollected() {
		...
		Global.setFileToEditContactIdList(idList);
		return true;
	}
