...
public class SimpleMonthView extends MonthView {
    ...
    public void drawMonthDay(Canvas canvas, int year, int month, int day, int x, int y,
        ...
        if (mSelectedDay == day) {
            canvas.drawCircle(x, y - MonthView.MINI_DAY_NUMBER_TEXT_SIZE / 3,
                MonthView.DAY_SELECTED_CIRCLE_SIZE, mSelectedCirclePaint);
        }
        // If we have a mindate or maxdate, gray out the day number if it's outside the
        // range.
