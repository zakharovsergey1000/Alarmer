...
public class RadialTextsView extends View {
    ...
    public void initialize(Resources res, String[] texts, String[] innerTexts,
        ...
        if (mIsInitialized) {
            Log.e(RadialTextsView.TAG,
                "This RadialTextsView may only be initialized once.");
            return;
        }
        // Set up the paint.
        ...
        // Initialize the widths and heights of the grid, and calculate the values for the
        // numbers.
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mTextGridValuesDirty) {
            ...
            if (mHasInnerCircle) {
                ...
                float innerNumbersRadius = mCircleRadius * mInnerNumbersRadiusMultiplier
                    * mAnimationRadiusMultiplier;
    ...
    /**
     * Using the trigonometric Unit Circle, calculate the positions that the text will
     * need to be drawn at based on the specified circle radius. Place the values in the
     * textGridHeights and textGridWidths parameters.
     */
    ...
    private void renderAnimations() {
        ...
        mDisappearAnimator = ObjectAnimator.ofPropertyValuesHolder(this, radiusDisappear,
        ...
        PropertyValuesHolder fadeIn = PropertyValuesHolder.ofKeyframe("alpha", kf0, kf1,
            kf2);
        mReappearAnimator = ObjectAnimator.ofPropertyValuesHolder(this, radiusReappear,
    ...
    public ObjectAnimator getDisappearAnimator() {
        if (!mIsInitialized || !mDrawValuesReady || mDisappearAnimator == null) {
            Log.e(RadialTextsView.TAG, "RadialTextView was not ready for animation.");
            return null;
        }
