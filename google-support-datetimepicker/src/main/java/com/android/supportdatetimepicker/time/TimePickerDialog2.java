...
public class TimePickerDialog2 extends DialogFragment implements OnValueSelectedListener {
    ...
    private static final String KEY_TIMESPAN = "KEY_TIMESPAN";
    private static final String KEY_SHOW_TIME_SPAN_OR_ABSOLUTE_TIME_SELECTOR = "KEY_SHOW_TIME_SPAN_OR_ABSOLUTE_TIME_SELECTOR";
    private static final String KEY_ABSOLUTE_TIME_HOURS = "KEY_ABSOLUTE_TIME_HOURS";
    private static final String KEY_ABSOLUTE_TIME_MINUTES = "KEY_ABSOLUTE_TIME_MINUTES";
    ...
    private RadioButton mRadioButtonTimeSpan;
    private RadioButton mRadioButtonAbsoluteTime;
    ...
    private int mAbsoluteTimeHours;
    private int mAbsoluteTimeMinutes;
    private boolean mShowTimeSpanOrAbsoluteTimeSelector;
    ...
    public interface OnTimeSetListener {
         ...
         * @param isTimeSpan TODO
         */
        void onTimeSet(RadialPickerLayout view, int callerId, int hours, int minutes,
                       boolean isTimeSpan);
    }
    ...
    public static TimePickerDialog2 newInstance(OnTimeSetListener callback, int callerId,
                                                int hourOfDay, int minute, boolean is24HourMode) {
        TimePickerDialog2 ret = new TimePickerDialog2();
        ret.initialize(callback, callerId, hourOfDay, minute, is24HourMode, false, 0,
            false);
        return ret;
    }

    public static TimePickerDialog2 newInstance(OnTimeSetListener callback, int callerId,
                                                int hourOfDay, int minute, boolean is24HourMode, boolean isTimeSpan,
                                                int timeSpan) {
        TimePickerDialog2 ret = new TimePickerDialog2();
        ret.initialize(callback, callerId, hourOfDay, minute, is24HourMode, isTimeSpan,
            timeSpan, true);
        return ret;
    }

    // public void initialize(OnTimeSetListener callback, int hourOfDay, int minute,
    // boolean is24HourMode, boolean isTimeSpan, int timeSpan) {
    // initialize(callback, hourOfDay, minute, is24HourMode, isTimeSpan, timeSpan, true);
    // }
    private void initialize(OnTimeSetListener callback, int callerId, int hourOfDay,
                            int minute, boolean is24HourMode, boolean isTimeSpan, int timeSpan,
                            boolean showTimeSpanOrAbsoluteTimeSelector) {
        mCallback = callback;
        mCallerId = callerId;
        mAbsoluteTimeHours = hourOfDay;
        mAbsoluteTimeMinutes = minute;
        mIs24HourModeInitial = is24HourMode;
        mIs24HourMode = is24HourMode;
        // mIsTimeSpan = isTimeSpan;
        mTimeSpan = timeSpan;
        if (isTimeSpan) {
            int hours = mTimeSpan / 60;
            if (hours > 23) {
                hours = 23;
            }
            mInitialHourOfDay = hours;
            mInitialMinute = mTimeSpan % 60;
            //
            mIs24HourMode = true;
        } else {
        ...
        mInKbMode = false;
        mThemeDark = false;
        mShowTimeSpanOrAbsoluteTimeSelector = showTimeSpanOrAbsoluteTimeSelector;
    }
    ...
    // }
    // }
    // public void setShowTimeSpanOrAbsoluteTimeSelector(boolean show) {
    // mShowTimeSpanOrAbsoluteTimeSelector = show;
    // }
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        if (savedInstanceState != null
            && savedInstanceState.containsKey(TimePickerDialog2.KEY_HOUR_OF_DAY)
            && savedInstanceState.containsKey(TimePickerDialog2.KEY_MINUTE)
            && savedInstanceState.containsKey(TimePickerDialog2.KEY_IS_24_HOUR_VIEW)) {
            // mIsTimeSpan = savedInstanceState
            // .getBoolean(TimePickerDialog2.KEY_IS_TIMESPAN);
            mCallerId = savedInstanceState.getInt(TimePickerDialog2.KEY_CALLER_ID);
            mTimeSpan = savedInstanceState.getInt(TimePickerDialog2.KEY_TIMESPAN);
            mShowTimeSpanOrAbsoluteTimeSelector = savedInstanceState
                .getBoolean(TimePickerDialog2.KEY_SHOW_TIME_SPAN_OR_ABSOLUTE_TIME_SELECTOR);
            mAbsoluteTimeHours = savedInstanceState
                .getInt(TimePickerDialog2.KEY_ABSOLUTE_TIME_HOURS);
            mAbsoluteTimeMinutes = savedInstanceState
                .getInt(TimePickerDialog2.KEY_ABSOLUTE_TIME_MINUTES);
            mInitialHourOfDay = savedInstanceState
                .getInt(TimePickerDialog2.KEY_HOUR_OF_DAY);
            mInitialMinute = savedInstanceState.getInt(TimePickerDialog2.KEY_MINUTE);
            mIs24HourModeInitial = savedInstanceState
                .getBoolean(TimePickerDialog2.KEY_IS_24_HOUR_VIEW_INITIAL);
            mIs24HourMode = savedInstanceState
                .getBoolean(TimePickerDialog2.KEY_IS_24_HOUR_VIEW);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.support_time_picker_dialog2, null);
        ...
        if (mShowTimeSpanOrAbsoluteTimeSelector) {
        ...
        mRadioButtonTimeSpan = (RadioButton) view
            .findViewById(R.id.radio_alarm_snooze_mode_timespan);
        mRadioButtonAbsoluteTime = (RadioButton) view
            .findViewById(R.id.radio_alarm_snooze_mode_absolute_time);
        // if (mIsTimeSpan) {
        // mRadioButtonTimeSpan.setChecked(true);
        // int hours = mTimeSpan / 60;
        // int minutes = mTimeSpan % 60;
        // mTimePicker.setTime(hours, minutes);
        // } else {
        // mRadioButtonAbsoluteTime.setChecked(true);
        // mTimePicker.setTime(mAbsoluteTimeHours, mAbsoluteTimeMinutes);
        // }
        mRadioButtonTimeSpan.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                // mIsTimeSpan = isChecked;
                if (isChecked) {
                    // mAbsoluteTimeHours = mTimePicker.getHours();
                    // mAbsoluteTimeMinutes = mTimePicker.getMinutes();
                    // TODO comment or not the line below
                    // int timeSpanX = mAbsoluteTimeHours * 60 + mAbsoluteTimeMinutes;
                    // if (timeSpanX > mTimeSpan) {
                    // mTimeSpan =
                    // } else {
                    // }
                    //
            ...
            .setOnCheckedChangeListener(new OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView,
                    ...
                    if (isChecked) {
                        ...
                        // mTimeSpan = hours * 60 + minutes;
                        mIs24HourMode = mIs24HourModeInitial;
                        mTimePicker.setTime(mAbsoluteTimeHours, mAbsoluteTimeMinutes);
                        setMinute(mAbsoluteTimeMinutes);
                        setHour(mAbsoluteTimeHours, true);
                    }
                }
            });
        ...
        mDoneButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCallback != null) {
                    mCallback.onTimeSet(mTimePicker, mCallerId, mTimePicker.getHours(),
                        mTimePicker.getMinutes(), mRadioButtonTimeSpan.isChecked());
                }
                dismiss();
            }
        });
        ...
        if (mIs24HourMode) {
            ...
            updateAmPmDisplay(mInitialHourOfDay < 12 ? TimePickerDialog2.AM
                : TimePickerDialog2.PM);
            mAmPmHitspace.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    tryVibrate();
                    int amOrPm = mTimePicker.getIsCurrentlyAmOrPm();
                    if (amOrPm == TimePickerDialog2.AM) {
                        amOrPm = TimePickerDialog2.PM;
                    } else if (amOrPm == TimePickerDialog2.PM) {
                        amOrPm = TimePickerDialog2.AM;
                    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (mTimePicker != null) {
            outState.putInt(TimePickerDialog2.KEY_CALLER_ID, mCallerId);
            if (mRadioButtonAbsoluteTime.isChecked()) {
                mAbsoluteTimeHours = mTimePicker.getHours();
                mAbsoluteTimeMinutes = mTimePicker.getMinutes();
            } else {
                mTimeSpan = mTimePicker.getHours() * 60 + mTimePicker.getMinutes();
            }
            // outState.putBoolean(TimePickerDialog2.KEY_IS_TIMESPAN, mIsTimeSpan);
            outState.putInt(TimePickerDialog2.KEY_TIMESPAN, mTimeSpan);
            outState.putBoolean(
                TimePickerDialog2.KEY_SHOW_TIME_SPAN_OR_ABSOLUTE_TIME_SELECTOR,
                mShowTimeSpanOrAbsoluteTimeSelector);
            outState.putInt(TimePickerDialog2.KEY_ABSOLUTE_TIME_HOURS, mAbsoluteTimeHours);
            outState.putInt(TimePickerDialog2.KEY_ABSOLUTE_TIME_MINUTES,
                mAbsoluteTimeMinutes);
            outState.putInt(TimePickerDialog2.KEY_HOUR_OF_DAY, mTimePicker.getHours());
            outState.putInt(TimePickerDialog2.KEY_MINUTE, mTimePicker.getMinutes());
            outState.putBoolean(TimePickerDialog2.KEY_IS_24_HOUR_VIEW_INITIAL,
                mIs24HourModeInitial);
            outState.putBoolean(TimePickerDialog2.KEY_IS_24_HOUR_VIEW, mIs24HourMode);
    ...
    public void onValueSelected(int pickerIndex, int newValue, boolean autoAdvance) {
        if (pickerIndex == TimePickerDialog2.HOUR_INDEX) {
        ...
        } else if (pickerIndex == TimePickerDialog2.AMPM_INDEX) {
    ...
    private void setCurrentItemShowing(int index, boolean animateCircle,
        ...
        if (index == TimePickerDialog2.HOUR_INDEX) {
            int hours = mTimePicker.getHours();
            if (!mIs24HourMode) {
                hours = hours % 12;
            }
        ...
        if (keyCode == KeyEvent.KEYCODE_ESCAPE || keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (mInKbMode) {
                if (!mTypedTimes.isEmpty()) {
                    ...
                    if (deleted == getAmOrPmKeyCode(TimePickerDialog2.AM)) {
                        deletedKeyStr = mAmText;
                    } else if (deleted == getAmOrPmKeyCode(TimePickerDialog2.PM)) {
            ...
            || !mIs24HourMode
            && (keyCode == getAmOrPmKeyCode(TimePickerDialog2.AM) || keyCode == getAmOrPmKeyCode(TimePickerDialog2.PM))) {
            if (!mInKbMode) {
                if (mTimePicker == null) {
     ...
     *
     * @param keyCode The key to use as the first press. Keyboard mode will not be started if
    ...
    private boolean isTypedTimeFullyLegal() {
        if (mIs24HourMode) {
            ...
            return mTypedTimes.contains(getAmOrPmKeyCode(TimePickerDialog2.AM))
                || mTypedTimes.contains(getAmOrPmKeyCode(TimePickerDialog2.PM));
        }
    }
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            setMinute(minute);
            if (!mIs24HourMode) {
                updateAmPmDisplay(hour < 12 ? TimePickerDialog2.AM : TimePickerDialog2.PM);
            }
    ...
    private int[] getEnteredTime(Boolean[] enteredZeros) {
        ...
        if (!mIs24HourMode && isTypedTimeFullyLegal()) {
            ...
            if (keyCode == getAmOrPmKeyCode(TimePickerDialog2.AM)) {
                amOrPm = TimePickerDialog2.AM;
            } else if (keyCode == getAmOrPmKeyCode(TimePickerDialog2.PM)) {
                amOrPm = TimePickerDialog2.PM;
            }
            startIndex = 2;
        }
    ...
    private void generateLegalTimesTree() {
        ...
        if (mIs24HourMode) {
            ...
            Node ampm = new Node(getAmOrPmKeyCode(TimePickerDialog2.AM),
                getAmOrPmKeyCode(TimePickerDialog2.PM));
