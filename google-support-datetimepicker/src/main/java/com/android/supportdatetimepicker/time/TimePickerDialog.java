...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null
            && savedInstanceState.containsKey(TimePickerDialog.KEY_HOUR_OF_DAY)
            && savedInstanceState.containsKey(TimePickerDialog.KEY_MINUTE)
            && savedInstanceState.containsKey(TimePickerDialog.KEY_IS_24_HOUR_VIEW)) {
            mInitialHourOfDay = savedInstanceState
                .getInt(TimePickerDialog.KEY_HOUR_OF_DAY);
            mInitialMinute = savedInstanceState.getInt(TimePickerDialog.KEY_MINUTE);
            mIs24HourMode = savedInstanceState
                .getBoolean(TimePickerDialog.KEY_IS_24_HOUR_VIEW);
            mInKbMode = savedInstanceState.getBoolean(TimePickerDialog.KEY_IN_KB_MODE);
            mThemeDark = savedInstanceState.getBoolean(TimePickerDialog.KEY_DARK_THEME);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.support_time_picker_dialog, null);
        ...
        mHourView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                setCurrentItemShowing(TimePickerDialog.HOUR_INDEX, true, false, true);
                tryVibrate();
            }
        });
        mMinuteView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                setCurrentItemShowing(TimePickerDialog.MINUTE_INDEX, true, false, true);
                tryVibrate();
            }
        });
        ...
        if (mIs24HourMode) {
            ...
            updateAmPmDisplay(mInitialHourOfDay < 12 ? TimePickerDialog.AM
                : TimePickerDialog.PM);
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (mTimePicker != null) {
            outState.putInt(TimePickerDialog.KEY_HOUR_OF_DAY, mTimePicker.getHours());
            outState.putInt(TimePickerDialog.KEY_MINUTE, mTimePicker.getMinutes());
            outState.putBoolean(TimePickerDialog.KEY_IS_24_HOUR_VIEW, mIs24HourMode);
            outState.putInt(TimePickerDialog.KEY_CURRENT_ITEM_SHOWING,
                mTimePicker.getCurrentItemShowing());
            outState.putBoolean(TimePickerDialog.KEY_IN_KB_MODE, mInKbMode);
            if (mInKbMode) {
                outState.putIntegerArrayList(TimePickerDialog.KEY_TYPED_TIMES,
                    mTypedTimes);
            }
            outState.putBoolean(TimePickerDialog.KEY_DARK_THEME, mThemeDark);
        }
    }
    ...
    public void onValueSelected(int pickerIndex, int newValue, boolean autoAdvance) {
        if (pickerIndex == TimePickerDialog.HOUR_INDEX) {
            ...
            if (mAllowAutoAdvance && autoAdvance) {
                setCurrentItemShowing(TimePickerDialog.MINUTE_INDEX, true, true, false);
    ...
    private void setCurrentItemShowing(int index, boolean animateCircle,
        ...
        int hourColor = index == TimePickerDialog.HOUR_INDEX ? mSelectedColor
            : mUnselectedColor;
        int minuteColor = index == TimePickerDialog.MINUTE_INDEX ? mSelectedColor
            : mUnselectedColor;
    ...
    private boolean processKeyUp(int keyCode) {
        if (keyCode == KeyEvent.KEYCODE_ESCAPE || keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            || !mIs24HourMode
            && (keyCode == getAmOrPmKeyCode(TimePickerDialog.AM) || keyCode == getAmOrPmKeyCode(TimePickerDialog.PM))) {
            if (!mInKbMode) {
                if (mTimePicker == null) {
    ...
    private boolean isTypedTimeFullyLegal() {
        if (mIs24HourMode) {
            ...
            return mTypedTimes.contains(getAmOrPmKeyCode(TimePickerDialog.AM))
                || mTypedTimes.contains(getAmOrPmKeyCode(TimePickerDialog.PM));
        }
    }
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            setMinute(minute);
            if (!mIs24HourMode) {
                updateAmPmDisplay(hour < 12 ? TimePickerDialog.AM : TimePickerDialog.PM);
            }
    ...
    private int[] getEnteredTime(Boolean[] enteredZeros) {
        ...
        for (int i = startIndex; i <= mTypedTimes.size(); i++) {
            int val = TimePickerDialog.getValFromKeyCode(mTypedTimes.get(mTypedTimes
                .size() - i));
            if (i == startIndex) {
                minute = val;
    ...
    private void generateLegalTimesTree() {
        ...
        if (mIs24HourMode) {
            ...
            Node ampm = new Node(getAmOrPmKeyCode(TimePickerDialog.AM),
