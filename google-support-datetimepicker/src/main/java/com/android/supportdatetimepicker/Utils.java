 ...
 * License. */
package com.android.supportdatetimepicker;
...
public class Utils {
	...
	/** Takes a number of weeks since the epoch and calculates the Julian day of the Monday
	 * for that week. This assumes that the week containing the
	 * {@link Time#EPOCH_JULIAN_DAY} is considered week 0. It returns the Julian day for
	 * the Monday {@code week} weeks after the Monday of the week containing the epoch.
	 *
	 * @param week
	 *            Number of weeks since the epoch
	 * @return The julian day for the Monday of the given week since the epoch */
	public static int getJulianMondayFromWeeksSinceEpoch(int week) {
		return Utils.MONDAY_BEFORE_JULIAN_EPOCH + week * 7;
	}

	/** Returns the week since {@link Time#EPOCH_JULIAN_DAY} (Jan 1, 1970) adjusted for
	 * first day of week. This takes a julian day and the week start day and calculates
	 * which week since {@link Time#EPOCH_JULIAN_DAY} that day occurs in, starting at 0.
	 * *Do not* use this to compute the ISO week number for the year.
	 *
	 * @param julianDay
	 *            The julian day to calculate the week number for
	 * @param firstDayOfWeek
	 *            Which week day is the first day of the week, see {@link Time#SUNDAY}
	...
	public static ObjectAnimator getPulseAnimator(View labelToAnimate,
		...
		pulseAnimator.setDuration(Utils.PULSE_ANIMATOR_DURATION);
