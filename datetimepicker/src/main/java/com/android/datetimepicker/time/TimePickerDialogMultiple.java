...
public class TimePickerDialogMultiple extends DialogFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.time_picker_multiple, container, false);
		...
		for (int i = 0; i < size; i++) {
			...
			RadioButton radioButton = (RadioButton) inflater.inflate(
					R.layout.time_selection_radiobutton, mRadioGroupTime, false);
	...
	private void setCurrentItemShowing(int index, boolean animateCircle,
		...
		if (delayLabelAnimate) {
			pulseAnimator.setStartDelay(TimePickerDialogMultiple.PULSE_ANIMATOR_DELAY);
		}
		pulseAnimator.start();
	}
